...
class NavBarExplore extends Component {
        ...
        return(
            <div id="navBar">
                <ul>
                    ...
                    <img src={zphereLogo} View style={{}} />  
                    </Link> 
                    </li>
                    <li>
                    <Link to="/explore" onClick = {this.aktiveUrl}>
                    <img src={ExploreIcon} />
                    </Link>
                    </li>
                    <li>
                    <Link style={navStyle} to="/merkliste" onClick = {this.aktiveUrl}>
